...
namespace VzFolders
{
    public class VzFoldersPalette : ScriptableObject
    {
        ...
        public void Export()
        {
            var packagePath = EditorUtility.SaveFilePanel("Export VzFolders Palette", "", this.GetPath().GetFilename(withExtension: false), "unitypackage");
