...
namespace VzFolders
{
    [CustomEditor(typeof(VzFoldersPalette))]
    class VzFoldersPaletteEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            void colors()
            {
                ...
                void adjustColorsButton()
                {
                    ...
                    var windowWidth = 270;
                    var windowHeight = VzFoldersMenu.backgroundColorsEnabled ? 92 : 73;
        ...
        VzFoldersPalette palette => target as VzFoldersPalette;
    ...
    class AddIconWindow : EditorWindow
    {
        ...
        public VzFoldersPalette palette;
        public VzFoldersPaletteEditor paletteEditor;
    ...
    class AdjustColorsWindow : EditorWindow
    {
        void OnGUI()
        {
            ...
            void body()
            {
                ...
                if (VzFoldersMenu.backgroundColorsEnabled)
