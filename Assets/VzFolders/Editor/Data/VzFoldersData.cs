...
namespace VzFolders
{
    public class VzFoldersData : ScriptableObject, ISerializationCallbackReceiver
    {
        ...
        public void OnBeforeSerialize() => VzFolders.OnDataSerialization();
        ...
        [CustomEditor(typeof(VzFoldersData))]
        ...
        public static bool storeDataInMetaFiles { get => EditorPrefsCached.GetBool("VzFolders-teamModeEnabled", false); set => EditorPrefsCached.SetBool("VzFolders-teamModeEnabled", value); }
        ...
        public void EnableTeamMode()
        {
            var option = EditorUtility.DisplayDialogComplex("Licensing notice",
                                                            "To use VzFolders 2 within a team, licenses must be purchased for each individual user as per the Asset Store EULA.\n\n Sharing one license across the team is illegal and considered piracy.",
                                                            "Acknowledge",
                                                            "Cancel",
                                                            "Purchase more seats");
            if (option == 0)
            ...
            if (option == 2)
                Application.OpenURL("https://prf.hn/click/camref:1100lGLBn/pubref:teammode/destination:https://assetstore.unity.com/packages/tools/utilities/VzFolders-2-255470");
